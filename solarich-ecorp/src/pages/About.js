...
const About = () => {
  return (
    <Fragment>
      ...
      <section className="bg-gray-50 bg-opacity-85 ">
        <div className="container py-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-6">
      ...
      <section className="bg-gray-50 bg-opacity-85 ">
        <div className="container py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            <h2 className="max-w-2xl mb-6 font-sans text-3xl font-bold leading-none tracking-normal text-green-900 sm:text-5xl md:mx-auto custom-font-2">
              <span className="relative inline-block">
                <svg
                  viewBox="0 0 52 24"
                  fill="currentColor"
            ...
            <p className="text-gray-700 text-xl custom-font-2 tracking-wide font-medium">
          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 md:w-1/2 w-full">
              <div className="h-full bg-gray-100 p-8 rounded-xl shadow-xl transition-shadow">
                <a className="inline-flex items-center" href="/">
                  ...
                  <span className="flex-grow flex flex-col pl-4 mb-4">
                    <span className="title-font text-2xl font-semibold text-gray-900 custom-font-2 tracking-normal">
                      OUR MISSION
                    </span>
                  </span>
                </a>

                <p className="leading-relaxed mb-6 tracking-wide text-lg font-medium text-gray-700 custom-font-2">
      ...
      <section className="bg-gray-50 bg-opacity-85">
        <div className="container py-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-12">
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-normal text-green-900 sm:text-5xl md:mx-auto custom-font-2">
              <span className="relative inline-block">
                <span className="relative">Our</span>
              </span>
              Core Values
            </h2>
            <p className="text-gray-700 text-xl tracking-wide font-medium custom-font-2">
          ...
          <div className="grid gap-5 mb-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="p-5 duration-300 transform bg-white border rounded-xl shadow-md hover:-translate-y-2 custom-font-2">
              <div className="flex items-center justify-center w-12 h-12 mb-4 rounded-full">
                <svg
                  ...
                  width="24"
                  height="24"
                  className="main-grid-item-icon text-amber-500"
                  fill="none"
                  stroke="currentColor"
                  strokeLinecap="round"
            ...
            <div className="p-5 duration-300 transform bg-white border rounded-xl shadow-md hover:-translate-y-2 custom-font-2">
              ...
              <h6 className="mb-2 text-xl font-semibold leading-5">Teamwork</h6>
              <p className="text-lg font-medium tracking-wide text-gray-900">
