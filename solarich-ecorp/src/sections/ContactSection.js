...
const ContactSection = () => {
  return (
    <Fragment>
      <section
        className="bg-gradient-to-r from-green-500 via-green-600 to-green-700 scroll-section"
        id="contact"
      >
              ...
              <div className="w-full max-w-xl mb-12 xl:pr-16 xl:mb-0 xl:w-7/12 custom-font-2">
                ...
                <p className="flex items-start mb-4 -mx-2">
                  <svg
                    ...
                    className="w-5 h-5 sm:w-6 sm:h-6 mt-0 sm:mt-0.5 mx-2 text-white"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth="2"
                  ...
                  <span className="mx-2 font-semibold text-sm sm:text-lg tracking-wide text-gray-50 truncate w-auto">
                    <a
                      href="https://goo.gl/maps/4mEtz6eKJZZZQ3GKA"
                      className="transition-colors duration-300 transform hover:opacity-75 md:hover:underline underline md:no-underline underline-offset-4"
                    >
                ...
                <p className="flex items-start mb-4 -mx-2">
                  ...
                  <span className="mx-2 font-semibold text-sm sm:text-lg tracking-wide text-gray-50 truncate w-auto">
                    <a
                      href="https://goo.gl/maps/AHpVHAHrv7et3v476"
                      className="transition-colors duration-300 transform hover:opacity-75 md:hover:underline underline md:no-underline underline-offset-4"
                    >
                      B71 L8 Ph. 11-A Wellington Place, Gen. Trias, Cavite
                    </a>
                  </span>
                </p>
                ...
                <p className="flex items-start mb-4 -mx-2">
                  ...
                  <span className="mx-2 font-semibold text-sm sm:text-lg tracking-wide text-gray-50 truncate w-72">
                    <a
                ...
                <p className="max-w-xl mb-4 mt-8 text-base text-gray-50 md:text-lg font-medium sm:texl-xl">
                ...
                <p className="flex items-start mb-4 -mx-2">
                  ...
                  <span className="mx-2 font-semibold text-sm sm:text-lg tracking-wide text-gray-50 truncate w-72">
                    <a
                      href="https://facebook.com/solarichtraining"
                      className="transition-colors duration-300 transform hover:opacity-75 md:hover:underline underline md:no-underline underline-offset-4"
                    >
                      facebook.com/solarichtraining
                    </a>
                  </span>
                </p>
