...
const CommercialProjects = () => {
  return (
    <Fragment>
      <section class="bg-gray-50 bg-opacity-85 scroll-section" id="commercial">
        <div class="container py-4 pb-14 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-6 lg:pb-20">
          <div class="relative">
            <div class="px-4 py-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:pb-12">
              <div class="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl text-center sm:text-center">
                <h2 class="mb-8 font-sans text-2xl font-bold tracking-normal text-green-900 sm:text-5xl sm:leading-none custom-font-2">
                  Our Featured Projects with
                  <br class="hidden md:block" />
                  <span class="relative inline-block px-3 py-2 mt-2">
                    <div class="absolute inset-0 transform -skew-x-12 custom-bg-dali"></div>
                    <span class="relative text-gray-50">
                      DALI Everyday Grocery
                    </span>
                  </span>
                </h2>
                <div class="flex items-center justify-center w-32 h-32 sm:w-36 sm:h-36 mb-2 mx-auto transition duration-300 hover:scale-110">
                  <img
                    class="w-full"
          ...
          <div class="grid gap-8 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
            {/* Content Block 1 */}
            <div class="overflow-hidden transition-shadow duration-300">
              <div class="group block overflow-hidden rounded-t-lg">
              ...
              <div class="p-5 border-2 border-t-0 rounded-b-lg">
                <p class="mb-3 text-xs font-semibold tracking-wide uppercase">
                  <span class="transition-colors duration-200 text-gray-800">
                    on-grid
                  </span>
                  <span class="text-gray-600">— 27 Jun 2023</span>
                </p>
                <a
                  href="https://web.facebook.com/solarichecorp/posts/pfbid02QzxhzZmVL2iWoWTwdyB8TJRgEKqGezhb4htnbod411nJc86BHQDv4KHFwDhcFtRvl"
                  class="inline-block mb-3 text-2xl font-bold leading-8 transition-colors duration-200 text-green-800 hover:text-green-500 underline underline-offset-4 custom-font-2 tracking-wide"
                >
                  DALI Wales, Parañaque
                </a>
                <p class="mb-2 text-gray-700 line-clamp-3 custom-font-2 tracking-wide font-medium read-more-text">
                ...
                <span
                  aria-label=""
                  class="inline-flex items-center font-semibold transition-colors duration-200 text-green-800 hover:text-green-500 cursor-pointer read-more-link"
            ...
            <div class="overflow-hidden transition-shadow duration-300">
              ...
              <div class="p-5 border-2 border-t-0 rounded-b-lg">
                <p class="mb-3 text-xs font-semibold tracking-wide uppercase">
                  ...
                  <span class="text-gray-600">— 14 Jul 2023</span>
                </p>
                <a
                  href="https://web.facebook.com/solarichecorp/posts/pfbid0rPYwCZWiu21jwuPWkiF8fJydvoEHYPNj3cughHNFG1gTTsFfcXgEdGfVkd5DLtrol"
                  class="inline-block mb-3 text-2xl font-bold leading-8 transition-colors duration-200 text-green-800 hover:text-green-500 underline underline-offset-4 custom-font-2 tracking-wide"
                >
            ...
            <div class="overflow-hidden transition-shadow duration-300">
              ...
              <div class="p-5 border-2 border-t-0 rounded-b-lg">
                <p class="mb-3 text-xs font-semibold tracking-wide uppercase">
                  ...
                  <span class="text-gray-600">— 19 Jul 2023</span>
                </p>
                <a
                  href="https://web.facebook.com/solarichecorp/posts/pfbid0rPYwCZWiu21jwuPWkiF8fJydvoEHYPNj3cughHNFG1gTTsFfcXgEdGfVkd5DLtrol"
                  class="inline-block mb-3 text-2xl font-bold leading-8 transition-colors duration-200 text-green-800 hover:text-green-500 underline underline-offset-4 custom-font-2 tracking-wide"
